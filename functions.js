// Initialize the application
	...
	EcwidApp.init({
	  app_id: "wooppay-dev", // use your application namespace
	  autoloadedflag: true, 
	  autoheight: true
	});
...
var initialConfig = {
	private: {
		url_api: "http://www.test.wooppay.com/api/wsdl",
		login_api: "test_merch",
		password_api: "A12345678a",
		order_prefix: "ecwid_test",
